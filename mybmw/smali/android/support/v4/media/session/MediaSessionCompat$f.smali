...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Lt0/b;Landroid/os/Bundle;)V
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p4}, Landroid/support/v4/media/session/MediaSessionCompat$f;->l(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/media/session/MediaSession;
    ...
    .line 8
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$f;->a(I)V
...
.method public c(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 3
    :cond_0
    invoke-virtual {p1}, Landroid/support/v4/media/MediaMetadataCompat;->k()Ljava/lang/Object;
...
.method public d(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 5
    :try_start_1
    invoke-interface {v2, p1}, Landroid/support/v4/media/session/a;->s1(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    :try_end_1
...
.method public e(Lg0/a;)V
    ...
    .line 2
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->p:Lg0/a;
...
.method public k()Lg0/a;
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->p:Lg0/a;
