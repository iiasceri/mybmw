...
.method protected constructor <init>(Lia/f;)V
    .locals 2
    ...
    .line 9
    invoke-virtual {p1}, Lia/f;->b()Landroid/os/Looper;
...
.method private final h()Lia/k;
    ...
    invoke-static {v1, v3}, Lka/q;->k(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lia/k;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lia/k;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lia/l;
    ...
    .line 5
    invoke-static {v1}, Lka/q;->h(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private final i(Lia/k;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;)V"
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lia/k;

    invoke-interface {p1}, Lia/k;->getStatus()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->m:Lka/k;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lia/l;

    goto :goto_0

    .line 3
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lia/l;

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lia/k;

    .line 4
    instance-of v0, v0, Lia/h;

    if-eqz v0, :cond_2

    new-instance v0, Lcom/google/android/gms/common/api/internal/p0;

    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/common/api/internal/p0;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;Lja/h0;)V

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Lcom/google/android/gms/common/api/internal/p0;
    ...
    .line 6
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h()Lia/k;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->a(Lia/l;Lia/k;)V
    ...
    .line 9
    invoke-interface {v2, v3}, Lia/g$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method static bridge synthetic j(Lcom/google/android/gms/common/api/internal/BasePendingResult;)Lia/k;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lia/k;

    return-object p0
.end method

.method public static l(Lia/k;)V
    .locals 2
    ...
    invoke-interface {v0}, Lia/h;->release()V
    :try_end_0
...
# virtual methods
.method public final b(Lia/g$a;)V
    .locals 2
    ...
    .line 3
    invoke-interface {p1, v1}, Lia/g$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final c(JLjava/util/concurrent/TimeUnit;)Lia/k;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 1
    invoke-static {v0}, Lka/q;->g(Ljava/lang/String;)V
    ...
    .line 2
    invoke-static {v0, v2}, Lka/q;->k(ZLjava/lang/Object;)V

    const-string v0, "Cannot await if then() has been called."

    .line 3
    invoke-static {v1, v0}, Lka/q;->k(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, p2}, Lka/q;->k(ZLjava/lang/Object;)V
...
.method protected abstract d(Lcom/google/android/gms/common/api/Status;)Lia/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final g(Lia/k;)V
    ...
    invoke-static {v1, v2}, Lka/q;->k(ZLjava/lang/Object;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->i(Lia/k;)V
    ...
    .line 6
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->l(Lia/k;)V
