...
# instance fields
.field private final baseUrl:Lhm/v;

.field private final contentType:Lhm/x;

.field private final hasBody:Z

.field private final headers:Lhm/u;
...
.method constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lhm/v;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lhm/v;
    ...
    .line 6
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lhm/u;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lhm/u;

    .line 7
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lhm/x;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lhm/x;
...
# virtual methods
.method create([Ljava/lang/Object;)Lhm/b0;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lhm/v;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lhm/u;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lhm/x;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lhm/v;Ljava/lang/String;Lhm/u;Lhm/x;ZZZ)V
    ...
    .line 9
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()Lhm/b0$a;
    ...
    invoke-virtual {p1, v0, v1}, Lhm/b0$a;->p(Ljava/lang/Class;Ljava/lang/Object;)Lhm/b0$a;
